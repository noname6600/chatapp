# message-reply-preview-resilience Specification

## Purpose
Define UI and interaction behavior for reply relationship rendering, including block-layout preview, clear sender labeling, reply-only highlight, and click-to-jump navigation with context loading.
