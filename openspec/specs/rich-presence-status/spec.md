...
The system SHALL render the effective presence status consistently in the friend list, room member presence views, and other global presence surfaces that consume presence-service data.
