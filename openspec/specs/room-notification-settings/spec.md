# room-notification-settings Specification

## Purpose
Define per-user room mute behavior for group chat rooms, including canonical mute-state loading, notification suppression rules, and private-chat exclusions.
