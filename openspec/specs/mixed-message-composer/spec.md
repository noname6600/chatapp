# mixed-message-composer Specification

## Purpose
Defines requirements for composing messages as ordered sequences of text and media blocks with media upload management and preview fidelity.
