## Purpose
Define how frontend WebSocket traffic is routed and authenticated through the API gateway while preserving real-time behavior, environment configurability, and reconnection resilience.
