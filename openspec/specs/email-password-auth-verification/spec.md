# email-password-auth-verification Specification

## Purpose
Defines email/password authentication, verified-email identity constraints, and verification flow requirements in auth-service.
