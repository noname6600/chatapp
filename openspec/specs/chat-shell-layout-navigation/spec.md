# chat-shell-layout-navigation Specification

## Purpose
Defines the chat page shell as a sidebar-first layout without a top header, with user identity and session actions anchored in the sidebar.
