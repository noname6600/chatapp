## Purpose
Define the requirement for Nginx to route production traffic by host, terminate TLS at the edge for both frontend and API domains, and preserve WebSocket upgrade headers for backend realtime endpoints.
