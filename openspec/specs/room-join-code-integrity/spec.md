# room-join-code-integrity Specification

## Purpose
Ensure room join codes keep user-entered case semantics and remain correctly scoped per room view so users see and submit the right code in concurrent navigation flows.
