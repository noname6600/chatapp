# chat-attachment-upload-through-upload-service Specification

## Purpose
Define chat attachment upload flow contracts that route preparation through upload-service and persist validated metadata references.
