...
### Requirement: Local hybrid runbook SHALL define infrastructure-only Docker startup
...
### Requirement: Local hybrid runbook SHALL include CLI commands for each backend service
...
### Requirement: Local hybrid runbook SHALL include infrastructure and startup verification commands
...
### Requirement: Local hybrid runbook SHALL define deterministic startup order and recovery commands
