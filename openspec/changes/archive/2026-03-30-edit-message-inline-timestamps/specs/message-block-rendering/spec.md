...
## Purpose
Defines how message blocks (text and media) are rendered, including handling of empty blocks and proper spacing to maintain clean UI in edited and newly-composed messages.
