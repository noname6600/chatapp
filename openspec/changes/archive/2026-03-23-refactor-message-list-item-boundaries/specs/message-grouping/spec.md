...
The system SHALL group consecutive messages from the same sender within a 2-minute window, and grouping derivation SHALL be performed at list layer before single-item rendering.
