...
Infrastructure and service runtime contracts MUST define explicit service-scoped database environment variables for database URL, username, and password.
