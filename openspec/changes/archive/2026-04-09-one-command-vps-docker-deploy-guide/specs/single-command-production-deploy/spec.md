...
The deployment process SHALL include a deterministic startup and verification sequence so different operators can achieve the same runtime outcome for frontend and API domains.
...
- **THEN** both deployments produce equivalent service topology and externally reachable domains for frontend and API ingress
