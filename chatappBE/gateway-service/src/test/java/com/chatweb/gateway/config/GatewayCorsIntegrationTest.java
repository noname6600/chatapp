...
class GatewayCorsIntegrationTest {
    ...
    void preflight_allowsConfiguredOrigin() {
                GatewayConfig config = new GatewayConfig(corsProperties("http://localhost:5173,http://localhost:5174"));
    ...
    void preflight_allowsProductionFrontendOrigin() {
        GatewayConfig config = new GatewayConfig(corsProperties("https://chatweb.nani.id.vn,https://api.chatweb.nani.id.vn"));
        ...
        private CorsProperties corsProperties(String allowedOriginsRaw) {
