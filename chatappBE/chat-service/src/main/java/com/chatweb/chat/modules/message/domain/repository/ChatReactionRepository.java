package com.chatweb.chat.modules.message.domain.repository;

import com.chatweb.chat.modules.message.domain.entity.ChatReaction;
import com.chatweb.chat.modules.message.domain.repository.projection.MessageReactionCountProjection;
