package com.chatweb.user.configuration;
...
/**
 * Protects internal user-service endpoints with a service credential header.
 */
@Slf4j
public class InternalServiceAuthFilter extends OncePerRequestFilter {
    ...
    private static final String INTERNAL_PATH_PREFIX = "/api/v1/users/internal";
    ...
    public InternalServiceAuthFilter(
            ...
            @Value("${internal.auth.token:}") String expectedToken,
    ...
    protected void doFilterInternal(
        ...
        if (expectedToken == null || expectedToken.isBlank()) {
            log.error("[INTERNAL-AUTH] internal.auth.token is not configured; rejecting internal request path={}", request.getRequestURI());
