...
public interface NotificationRepository extends JpaRepository<Notification, UUID> {
    ...
    @Query("""
        ...
        ORDER BY
          CASE
            WHEN n.type = com.chatweb.notification.entity.NotificationType.FRIEND_REQUEST AND n.isRead = false THEN 0
    ...
    @Query("""
        ...
        WHERE n.userId = :userId
          AND n.isRead = false
          AND n.type <> com.chatweb.notification.entity.NotificationType.FRIEND_REQUEST
    """)
