...
import com.chatweb.auth.entity.PasswordResetToken;
import com.chatweb.auth.repository.AccountRepository;
import com.chatweb.auth.repository.PasswordResetTokenRepository;
...
public class ForgotPasswordService implements IForgotPasswordService {
    ...
    public void requestReset(String email) {
        // Always return silently â€” never leak account existence
