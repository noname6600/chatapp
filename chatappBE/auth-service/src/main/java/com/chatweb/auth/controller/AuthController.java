...
import com.chatweb.auth.service.IAuthService;
import com.chatweb.auth.service.IForgotPasswordService;
...
public class AuthController extends BaseController {
    ...
    public ResponseEntity<ApiResponse<Void>> logoutAll(
            @AuthenticationPrincipal JwtPrincipal principal
                ...
                authService.logoutAll(requirePrincipal(principal).getAccountId());
        return ok();
    }
    ...
    public ResponseEntity<ApiResponse<Void>> setPassword(
        ...
        JwtPrincipal authenticatedPrincipal = requirePrincipal(principal);
        authService.setPassword(
                authenticatedPrincipal.getAccountId(),
    ...
    public ResponseEntity<ApiResponse<EmailVerificationStatusResponse>> getEmailVerificationStatus(
        ...
        EmailVerificationStatusResponse response = authService.getEmailVerificationStatus(
                requirePrincipal(principal).getAccountId()
        );
        return ok(response);
    }
    ...
    public ResponseEntity<ApiResponse<Void>> sendVerificationEmail(
            @AuthenticationPrincipal JwtPrincipal principal
                ...
                authService.sendVerificationEmail(requirePrincipal(principal).getAccountId());
        return ok();
    }
