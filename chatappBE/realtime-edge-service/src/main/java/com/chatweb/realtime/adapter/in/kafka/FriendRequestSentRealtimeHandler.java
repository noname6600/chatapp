...
public class FriendRequestSentRealtimeHandler implements KafkaEventHandler<Object> {

    private final FriendshipRealtimeDeliveryService friendshipDeliveryService;
    private final ObjectMapper objectMapper;

    @Override
    public String eventType() { return "friend.request.sent"; }
    ...
    public void handle(EventEnvelope<Object> event) {
        ...
        friendshipDeliveryService.deliverToUser(recipientId, "friendship.request.received", eventId, wsPayload);
    }
