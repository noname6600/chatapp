...
@Component
public class ChatEventDedupeGuard {

    private static final Duration TTL = Duration.ofMinutes(5);
    private static final String KEY_PREFIX = "dedup:realtime:chat:";

    private final StringRedisTemplate redisTemplate;

    public ChatEventDedupeGuard(StringRedisTemplate redisTemplate) {
