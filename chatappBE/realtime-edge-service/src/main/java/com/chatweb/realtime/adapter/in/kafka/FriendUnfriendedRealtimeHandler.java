...
public class FriendUnfriendedRealtimeHandler implements KafkaEventHandler<Object> {

    private final FriendshipRealtimeDeliveryService friendshipDeliveryService;
    private final ObjectMapper objectMapper;

    @Override
    public String eventType() { return "friend.unfriended"; }
    ...
    public void handle(EventEnvelope<Object> event) {
        ...
        wsPayload.put("eventType", "friend.unfriended");
