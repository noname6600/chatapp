...
public class FriendBlockedRealtimeHandler implements KafkaEventHandler<Object> {

    private final FriendshipRealtimeDeliveryService friendshipDeliveryService;
    private final ObjectMapper objectMapper;

    @Override
    public String eventType() { return "friend.blocked"; }
    ...
    public void handle(EventEnvelope<Object> event) {
        ...
        wsPayload.put("eventType", "friend.blocked");
